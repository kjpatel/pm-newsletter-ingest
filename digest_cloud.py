...
Self-contained script that fetches RSS feeds, summarizes articles with Claude,
ranks them by relevance, and sends a weekly digest email via Resend.

Designed to run in GitHub Actions with no local filesystem dependencies.
"""
...
def main():
    ...
    for article in articles:
        try:
            ...
            log.info(f"Summarized: {article['title']}")
